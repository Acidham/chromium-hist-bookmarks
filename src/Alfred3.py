...
class Items(object):
    ...
    def setKv(self, key: str, value: str):
        """
    ...
    def setIcon(self, m_path: str, m_type=""):
        """
    ...
    def __define_icon(self, path: str, m_type="") -> dict:
        """
    ...
    def addMod(self, key: str, arg: str, subtitle: str, valid=True, icon_path="", icon_type=""):
        """
    ...
    def updateItem(self, id: int, key: str, value: str):
        """
    ...
    def write(self, response_type: str = 'json'):
        """
...
class Tools(object):
    ...
    @staticmethod
    def getDateStr(float_time: float, format='%d.%m.%Y') -> str:
        """
    ...
    @staticmethod
    def sortListDict(list_dict: list, key: str, reverse=True) -> list:
        """
    ...
    @staticmethod
    def sortListTuple(list_tuple: list, el: int, reverse=True) -> list:
        """
...
class Plist:
    ...
    def deleteVariable(self, variable: str):
        """
